...
@rem ##########################################################################
@rem
@rem  Assignment startup script for Windows
@rem
@rem ##########################################################################
...
@rem Execute Assignment
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ASSIGNMENT_OPTS%  -classpath "%CLASSPATH%" WizardTD.App %*
...
if not ""=="%ASSIGNMENT_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
